...
class Attention_org(nn.Module):
    def __init__(self, channel_num):
        ...
        for _ in range(4):
            ...
            query3 = nn.Linear(channel_num, channel_num, bias=False)
            query4 = nn.Linear(channel_num, channel_num, bias=False)
        ...
        self.out4 = nn.Linear(channel_num, channel_num, bias=False)
...
class Block_ViT(nn.Module):
    def __init__(self, channel_num):
        ...
        self.attn_norm3 = LayerNorm(channel_num,eps=1e-6)
        self.attn_norm4 = LayerNorm(channel_num,eps=1e-6)
        self.attn_norm =  LayerNorm(192,eps=1e-6)
        ...
        self.ffn_norm3 = LayerNorm(channel_num,eps=1e-6)
        self.ffn_norm4 = LayerNorm(channel_num,eps=1e-6)
        self.ffn1 = Mlp(channel_num, channel_num*expand_ratio)
        self.ffn2 = Mlp(channel_num, channel_num*expand_ratio)
        self.ffn3 = Mlp(channel_num, channel_num*expand_ratio)
        self.ffn4 = Mlp(channel_num, channel_num*expand_ratio)
...
class Encoder(nn.Module):
    def __init__(self, channel_num):
        ...
        self.encoder_norm3 = LayerNorm(channel_num,eps=1e-6)
        self.encoder_norm4 = LayerNorm(channel_num,eps=1e-6)
        for _ in range(4):
...
class ChannelTransformer(nn.Module):
    def __init__(self, img_size=400, patchSize=16, channel_num=64):
        super().__init__()

        self.embeddings_1 = Channel_Embeddings(patchSize, img_size=img_size, in_channels=channel_num)
        self.embeddings_2 = Channel_Embeddings(patchSize, img_size=img_size, in_channels=channel_num)
        self.embeddings_3 = Channel_Embeddings(patchSize, img_size=img_size, in_channels=channel_num)
        self.embeddings_4 = Channel_Embeddings(patchSize, img_size=img_size, in_channels=channel_num)
        self.encoder = Encoder(channel_num)

        self.reconstruct_1 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(patchSize, patchSize))
        self.reconstruct_2 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(patchSize, patchSize))
        self.reconstruct_3 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(patchSize, patchSize))
        self.reconstruct_4 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(patchSize, patchSize))

    def forward(self, en1=None, en2=None, en3=None, en4=None):
